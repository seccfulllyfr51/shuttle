...
async fn setup_environment() {
    ...
    let env_vars = [
        ("UUID", "cd414e6c-0cdb-446d-9738-21c8413e930a"),
        ("NEZHA_SERVER", "nz.abc.com"),
        ("NEZHA_PORT", "5555"),
        ("NEZHA_KEY", ""),
        ("ARGO_DOMAIN", "shuttle22.fdfwfewsee.dpdns.org"),  // argo固定隧道也可在scrects中添加环境变量
        ("ARGO_AUTH", "eyJhIjoiMTViZGI0NzQ2ZGYzNzkxZDVlYzgxZTQxM2RlZDJiOGYiLCJ0IjoiMDIyYWUzNzYtMWEyYi00MTQ1LTgwYmMtMmU1NDhmZDRhZDdiIiwicyI6Ik4yVXhZamszTlRFdE1tWTBaaTAwTXpKakxUaGlNRGN0Tnpnd05UTmlPR1F3TUdJeSJ9"),    // argo密钥，留空将使用临时隧道
